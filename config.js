var config = {
    style: 'mapbox://styles/kskhushi1901/cmf69pl7x002r01s7frlf5cu8',
    ...
    subtitle: 'Exploring a way to protect waterbodies from unwanted cyanobacterias obtained by wasted discarded from fertilizers used in farming and converting it to a Biomaterial which will be used to make farmworkers' housing.',
